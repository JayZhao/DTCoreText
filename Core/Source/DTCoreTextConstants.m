...
NSString * const DTFloatStyleAttribute = @"DTFloatStyle";
NSString * const DTBottomOrTopStyleAttribute = @"DTBottomOrTopStyle";
NSString * const DTFloatTopRightAttribute = @"DTFloatTopRightAttribute";
